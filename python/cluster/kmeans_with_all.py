...
print("Save model")
joblib.dump(kmeans, dataset_name + '/all.pkl') 

print("Save as txt file")
np.savetxt(dataset_name + '/train_all.txt', kmeans.labels_, delimiter=',', fmt='%i')
np.savetxt(dataset_name + '/test_all.txt', kmeans.predict(test_data), delimiter=',', fmt='%i')
